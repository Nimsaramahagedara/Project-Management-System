...
import { countAcademicDays, getSemester } from '../../utils/usefulFunctions';
  ...
  return (
    <ContainerStudent>
      ...
      <div className='flex flex-wrap items-center md:justify-between justify-around md:gap-0 gap-2 '>
        <ColorCard bgColor={'#eafce8'} name={'Current Semester'} count={`${getSemester()}/2`} icon={<SignalCellularAltIcon/>}/>
