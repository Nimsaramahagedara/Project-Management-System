...
export const getSemester = () => {
  ...
  if (currentMonthIndex >= 1 && currentMonthIndex <= 5) {
    return 1; // February to June, 1st semester
  } else if (currentMonthIndex >= 6 && currentMonthIndex <= 11) {
    return 2; // July to December, 2nd semester
  } else if (currentMonthIndex === 0) {
    return 'break'; // January, semester break
  } else {
